...
npm run build
```
npm run watch - просмотр в режиме реального времени
...
---
#Описание проекта
Настроенный слайдер на моб версии в планшете и на десктопе слайдар преоюразуется в обычные блоки; кнопка на js с изменением текста и наплавления картинки; при нажатии на кноку в появляюся доп блоки.
